...
void	ft_argv2list(char **nums, int count, t_list *head_p, int start);
...
void	ft_news_nums2list(char **nums, int count, t_list *head_p);
char	**typeof_input(char **nums, int *argc, int *start);
void	check_repeats(int *new_nums, int number, int count);
void	check_dupes(t_list *list, t_list *head_p);
//Libft
